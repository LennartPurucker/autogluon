...
class BaggedEnsembleModel(AbstractModel):
    ...
    **kwargs
    ...
    def _fit_single(self, X, y, model_base, use_child_oof, time_limit=None, skip_oof=False, **kwargs):
        ...
        if not skip_oof:
            ...
            if use_child_oof:
                ...
                self._oof_pred_proba = model_base.predict_proba(X=X, is_val_predict=True)  # TODO: Cheater value, will be overfit to valid set
    ...
    def compute_feature_importance(self, X, y, features=None, silent=False, time_limit=None, is_oof=False, from_children=False, **kwargs) -> pd.DataFrame:
        if features is None:
